...
class ActionMasterEngine:
    def __init__(self, recipe_data):
        ...
        # Architecture detection for Wan 2.2
    ...
    def scan_lora_density(self, lora_sd):
        """Calculates weight magnitude to suggest injection heat."""
    ...
    def find_lora_keys(self, lora_sd, target_key):
        """Universal Mapping: Normalized slug-matching for Dots vs Underscores."""
    ...
    def process_pass(self, step, global_mult):
        ...
        for f in features:
            ...
            avg_mag, _ = self.scan_lora_density(lora_sd)
            print(f"🔍 SCAN [{f['file']}]: Mag: {avg_mag:.4f} | Mode: {'INJECTION' if use_smart else 'ADDITION'}")
            ...
            for target_key in self.base_keys:
                ...
                with torch.no_grad():
                    ...
                    elif dk: # Dense path (DARE-TIES Sparsity fallback)
                        k_type = "dense"
